...
{
    // Installs the project's packages via the PackageManager Client API, headless-safe.
    // Run with the Editor binary directly (NOT `unity run`, which injects -quit):
    //   Unity.exe -batchmode -projectPath <proj> -executeMethod ProjectBootstrap.PackageInstaller.Install -logFile -
